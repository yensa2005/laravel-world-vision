...
@section('title', 'Đăng ký - AKINA CENTER')

@section('content')
    <div class="d-lg-flex half justify-content-between">
        <div class="bg order-1 order-md-2" style="background-image: url('../assets/images/admin/bg_2.jpg');"></div>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-7 mt-5">
                        <a class="navbar-brand mb-5" href="/home"><img src="{{ asset('assets/images/logo-01.png') }}"
                                alt="" width="200"></a>
                        <h3>Tham gia vào <b>AKINA CENTER</b></h3>
                        ...
                        <form action="#" method="post">
                            ...
                            <input type="submit" value="Đăng ký" class="btn btn-block btn-dark">
