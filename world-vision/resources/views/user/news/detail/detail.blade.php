    ...
    <div class="col-lg-9">
        <article>
            <div class="news-post-wrapper">
                ...
                <a class="badge bg-secondary text-white text-decoration-none link-light" href="#!">#iphone13</a>
                <a class="badge bg-secondary text-white text-decoration-none link-light" href="#!">#face id</a>
                <a class="badge bg-secondary text-white text-decoration-none link-light" href="#!">#Ming-Chi Kuo</a>
                <a class="badge bg-secondary text-white text-decoration-none link-light" href="#!">#chip Apple A15</a>
                        ...
                        <div class="col-sm-12">
                            <div class="d-flex justify-content-center">
                                <div class="d-flex justify-content-center footer-social">
                                    <ul class="social-media" style="padding-left: 0;">
                                        <li>
                                            <a href="#">
                ...
                <hr class="mt-4 mb-5">
                <h5 class="text-dark font-weight-medium">Có thể bạn sẽ thích</h5>
